...
payment_info = contract.functions.getPaymentInfo(selected_token_id).call()
st.write(f"Amplify Fee: {payment_info[0]}")
st.write(f"Vocalist Payment: {payment_info[1]}")
st.write(f"Original Artist Payment: {payment_info[2]}")
st.write(f"Record Label Payment: {payment_info[3]}")
st.write(f"Remix Artist Payment: {payment_info[4]}")
st.write(f"ETH Value: {payment_info[5]}")
st.write(f"Tokens Minted: {payment_info[6]}")
st.write(f"Mint Timestamp: {payment_info[7]}")
